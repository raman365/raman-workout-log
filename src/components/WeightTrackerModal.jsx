...
const THEMES = {
  ...
  Kristin: {
    ...
    surfaceHex: '#1f0d12',
    field: 'bg-[#2e1419]',
    fieldFocus: 'focus:bg-[#3d1a22]',
    border: 'border-rose-900/40',
    focusBorder: 'focus:border-rose-500',
    divider: 'border-rose-900/40',
    accentGrad: 'bg-gradient-to-r from-rose-500 to-pink-400',
    accentHover: 'hover:from-rose-400 hover:to-pink-300',
    accentShadow: 'shadow-rose-500/30',
    accentText: 'text-rose-400',
    accentTextHover: 'hover:text-rose-400',
    muted: 'text-rose-300/40',
    muted50: 'text-rose-300/50',
    muted30: 'text-rose-300/30',
    muted20: 'text-rose-300/20',
    mutedHover: 'hover:text-rose-300',
    rowText: 'text-rose-200/70',
    summary: 'bg-rose-500/10 border-rose-500/30',
    clearBtn: 'bg-rose-900/40 text-rose-300/60',
    chartStroke: '#fb7185',
    chartDot: '#fda4af',
  },
}
